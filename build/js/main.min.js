...
/***/ "./js/modules/cookies-banner-handler.js":
/*!**********************************************!*\
  !*** ./js/modules/cookies-banner-handler.js ***!
  \**********************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   cookiesBannerHandler: function() { return /* binding */ cookiesBannerHandler; }
/* harmony export */ });
var cookiesBannerHandler = function cookiesBannerHandler() {
  var cookiesBanner = document.querySelector("[data-cookies]");
  if (!cookiesBanner) return;
  var btn = document.querySelector('[data-cookies="button"]');
  if (!btn) return;
...
/***/ "./js/modules/feedback/feedback.js":
/*!*****************************************!*\
  !*** ./js/modules/feedback/feedback.js ***!
  \*****************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
var Feedback = /*#__PURE__*/function () {
  function Feedback() {
    ...
    this._modals = _modal_init_modals__WEBPACK_IMPORTED_MODULE_0__.modals;
    this._feedback = document.querySelectorAll('[data-feedback]');
    this._onSubmitForm = this._onSubmitForm.bind(this);
    this._emailRegex = /^(((?:(?![\t-\r "\(\),\.:-<>@\[\]\xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uD800-\uDFFF\uFEFF])[^]|[\uD800-\uDBFF][\uDC00-\uDFFF])+(\.(?:(?![\t-\r "\(\),\.:-<>@\[\]\xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uD800-\uDFFF\uFEFF])[^]|[\uD800-\uDBFF][\uDC00-\uDFFF])+)*)|("(?:[\0-\t\x0B\f\x0E-\u2027\u202A-\uD7FF\uE000-\uFFFF]|[\uD800-\uDBFF][\uDC00-\uDFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF])+"))@(((?:(?![\t-\r "\(\),\.:-<>@\[\]\xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uD800-\uDFFF\uFEFF])[^]|[\uD800-\uDBFF][\uDC00-\uDFFF])+\.)+(?:(?![\t-\r "\(\),\.:-<>@\[\]\xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uD800-\uDFFF\uFEFF])[^]|[\uD800-\uDBFF][\uDC00-\uDFFF]){2,})$/i;
  ...
  return _createClass(Feedback, [{
    ...
    value: function init() {
      ...
      this._feedback.forEach(function (element) {
        var form = element.querySelector('[data-feedback-form]');
        form.addEventListener('submit', _this._onSubmitForm);
      });
    }
  }, {
    key: "_getToken",
      ...
      var _getToken2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 2:
              _context.next = 4;
              return grecaptcha.execute('6Leyv2srAAAAAGn0HxWmAbFXhO7Qky6eYc21Ps60', {
                action: 'submit'
              });
            case 4:
              token = _context.sent;
    ...
    key: "_onSubmitForm",
    value: function () {
      var _onSubmitForm2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(evt) {
        var _this2 = this;
        var form, feedback, errors, token, formData, response, result, modal, errorResult;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              evt.preventDefault();
              form = evt.target;
              feedback = form.closest('[data-feedback]');
              errors = form.querySelector('[data-feedback-errors]');
            ...
            case 14:
              ...
              _context2.prev = 18;
              _context2.next = 21;
              return fetch('/local/templates/zhbi-street/ajax/feedback.php', {
                method: 'POST',
                body: formData
              });
            case 21:
            ...
            case 24:
              ...
              if (result.TYPE === 'success') {
                ...
                errorResult = '';
                Array.from(result.RESULT).forEach(function (error) {
                  errorResult += _this2._createError(error);
                });
      ...
      function _onSubmitForm(_x) {
        return _onSubmitForm2.apply(this, arguments);
      }
      return _onSubmitForm;
    }()
  }, {
    key: "_validateForm",
    value: function _validateForm(form) {
      var _this3 = this;
      this._errors.clear();
      var fields = form.querySelectorAll('[data-validate-type]');
      fields.forEach(function (field) {
        var type = field.dataset.validateType;
        switch (type) {
          case 'text':
            _this3._validateTextField(field);
            break;
          case 'phone':
            _this3._validatePhoneField(field);
            break;
          case 'email':
            _this3._validateEmailField(field);
            break;
        }
      });
    }
  }, {
    key: "_validateTextField",
    value: function _validateTextField(field) {
    ...
    key: "_validatePhoneField",
    value: function _validatePhoneField(field) {
      var input = field.querySelector('input');
      if (!input.value) {
        field.classList.add('is-error');
        this._errors.add('required');
    ...
    key: "_validateEmailField",
    value: function _validateEmailField(field) {
      var input = field.querySelector('input');
      if (!input.value) {
        field.classList.add('is-error');
        this._errors.add('required');
    ...
    key: "_setErrors",
    value: function _setErrors(element) {
      var _this4 = this;
      var result = '';
      this._errors.forEach(function (error, errorAgain, set) {
        switch (error) {
          case 'required':
            result += _this4._createError('Заполните все обязательные поля');
            break;
          case 'phone':
            result += _this4._createError('Введите пожалуйста корректный номер телефона');
            break;
          case 'email':
            result += _this4._createError('Введите пожалуйста корректный адрес электронной почты');
            break;
        }
      });
    ...
    key: "_createError",
    value: function _createError(text) {
      return "\n      <div class=\"errors__item\">\n        <svg width=\"20\" height=\"20\" aria-hidden=\"true\">\n          <use xlink:href=\"#icon-attention\"></use>\n        </svg>\n        <p class=\"errors__text\">".concat(text, "</p>\n      </div>\n    ");
    }
  }]);
}();
...
/***/ "./js/modules/feedback/init-feedback.js":
/*!**********************************************!*\
  !*** ./js/modules/feedback/init-feedback.js ***!
  \**********************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initFeedback: function() { return /* binding */ initFeedback; }
/* harmony export */ });
/* harmony import */ var _feedback__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./feedback */ "./js/modules/feedback/feedback.js");

var initFeedback = function initFeedback() {
  var feedback = new _feedback__WEBPACK_IMPORTED_MODULE_0__.Feedback();
  feedback.init();
};
...
var HeaderAccordion = /*#__PURE__*/function () {
  ...
  return _createClass(HeaderAccordion, [{
    key: "init",
    value: function init() {
      if (!this._menu) {
        return;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initMoreBtn: function() { return /* binding */ initMoreBtn; }
/* harmony export */ });
...
var onFocusPhoneInput = function onFocusPhoneInput(_ref2) {
  ...
  if (!target.value) {
    ...
    target.addEventListener('blur', _onBlurPhoneInput);
...
var _onBlurPhoneInput = function onBlurPhoneInput(_ref3) {
  var target = _ref3.target;
  if (target.value === COUNTRY_CODE) {
    target.value = '';
    target.removeEventListener('input', onInputPhoneInput);
    target.removeEventListener('blur', _onBlurPhoneInput);
  }
};
  ...
  if (phoneInputs.length) {
    phoneInputs.forEach(function (input) {
      ...
      if (input.value) {
        ...
        input.addEventListener('blur', _onBlurPhoneInput);
...
/***/ "./js/modules/init-product-handler.js":
/*!********************************************!*\
  !*** ./js/modules/init-product-handler.js ***!
  \********************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initProductHandler: function() { return /* binding */ initProductHandler; }
/* harmony export */ });
var initProductHandler = function initProductHandler() {
  if (document.querySelectorAll('[data-open-modal="modal-order-form"]').length === 0) {
    return;
  }
  var modalOrder = document.querySelector('[data-modal="modal-order-form"]');
  var modalOrderTitle = modalOrder.querySelector('[data-modal-product-title]');
  var modalOrderInputTitle = modalOrder.querySelector('[data-modal-input-product-title]');
  var modalOrderInputPrice = modalOrder.querySelector('[data-modal-input-product-price]');
  document.addEventListener('click', function (event) {
    if (event.target.closest('[data-open-modal="modal-order-form"]')) {
      var parent = event.target.closest('[data-open-modal="modal-order-form"]');
      var productTitle = parent.querySelector('[data-product-title]').innerHTML;
      var productPrice = parent.querySelector('[data-product-price]').innerHTML;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initVideo: function() { return /* binding */ initVideo; }
/* harmony export */ });
var initVideo = function initVideo() {
  var videoFile = document.querySelector('#video-story');
  var videoBtn = document.querySelector('.history__btn-play');
  var videoOverlay = document.querySelector('.history__overlay');
  if (videoBtn) {
...
var ShowMore = /*#__PURE__*/function () {
  ...
  return _createClass(ShowMore, [{
    ...
    key: "_getContent",
    value: function () {
      var _getContent2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var currentPage, params, response, result;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.prev = 3;
              _context.next = 6;
              return fetch('/local/templates/zhbi-street/ajax/get-content.php', {
                method: 'POST',
                headers: {
...
/***/ "./js/modules/sliders/init-object-slider.js":
/*!**************************************************!*\
  !*** ./js/modules/sliders/init-object-slider.js ***!
  \**************************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initObjectSlider: function() { return /* binding */ initObjectSlider; }
/* harmony export */ });
var initObjectSlider = function initObjectSlider() {
  var objectSlider = document.querySelector('[data-slider="object-slider"]');
  var objectSubSlider = document.querySelector('[data-slider="object-sub-slider"]');
  var buttonPrev = document.querySelector('[data-slider="object-slider-button-prev"]');
  var buttonNext = document.querySelector('[data-slider="object-slider-button-next"]');
  if (!objectSlider || !objectSubSlider) return;
  var mainObjectSubSlider = new Swiper(objectSubSlider, {
    slidesPerView: 3,
    spaceBetween: 10,
    direction: 'vertical',
    navigation: {
  ...
  var mainObjectSlider = new Swiper(objectSlider, {
    navigation: {
      nextEl: buttonNext,
      prevEl: buttonPrev
    },
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   mobileVhFix: function() { return /* binding */ mobileVhFix; }
/* harmony export */ });
...
var mobileVhFix = function mobileVhFix() {
  ...
  if (!isIE && (isMobile || (0,_ios_checker__WEBPACK_IMPORTED_MODULE_0__.iosChecker)())) {
...
/* harmony import */ var _modules_accordion_init_accordion__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/accordion/init-accordion */ "./js/modules/accordion/init-accordion.js");
...
/* harmony import */ var _modules_tabs_init_tabs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/tabs/init-tabs */ "./js/modules/tabs/init-tabs.js");
/* harmony import */ var _modules_header_accordion_init_header_accordion__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/header-accordion/init-header-accordion */ "./js/modules/header-accordion/init-header-accordion.js");
/* harmony import */ var _modules_fancybox_init_fancybox__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/fancybox/init-fancybox */ "./js/modules/fancybox/init-fancybox.js");
/* harmony import */ var _modules_sliders_init_object_slider_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/sliders/init-object-slider.js */ "./js/modules/sliders/init-object-slider.js");
/* harmony import */ var _modules_cookies_banner_handler__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/cookies-banner-handler */ "./js/modules/cookies-banner-handler.js");
/* harmony import */ var _modules_init_video_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/init-video.js */ "./js/modules/init-video.js");
/* harmony import */ var _modules_feedback_init_feedback__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/feedback/init-feedback */ "./js/modules/feedback/init-feedback.js");
/* harmony import */ var _modules_init_more_btn_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/init-more-btn.js */ "./js/modules/init-more-btn.js");
/* harmony import */ var _modules_init_product_handler_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./modules/init-product-handler.js */ "./js/modules/init-product-handler.js");
/* harmony import */ var _modules_show_more_init_show_more_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./modules/show-more/init-show-more.js */ "./js/modules/show-more/init-show-more.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_utils_mobile_vh_fix__WEBPACK_IMPORTED_MODULE_0__.mobileVhFix)();
  ...
  (0,_modules_accordion_init_accordion__WEBPACK_IMPORTED_MODULE_1__.initAccordion)();
  (0,_modules_tabs_init_tabs__WEBPACK_IMPORTED_MODULE_5__.initTabs)();
  (0,_modules_header_accordion_init_header_accordion__WEBPACK_IMPORTED_MODULE_6__.initHeaderAccordion)();
  (0,_modules_fancybox_init_fancybox__WEBPACK_IMPORTED_MODULE_7__.initFancybox)();
  (0,_modules_cookies_banner_handler__WEBPACK_IMPORTED_MODULE_9__.cookiesBannerHandler)();
  (0,_modules_init_video_js__WEBPACK_IMPORTED_MODULE_10__.initVideo)();
  (0,_modules_init_phone_mask__WEBPACK_IMPORTED_MODULE_4__.initPhoneMask)();
  (0,_modules_feedback_init_feedback__WEBPACK_IMPORTED_MODULE_11__.initFeedback)();
  (0,_modules_init_more_btn_js__WEBPACK_IMPORTED_MODULE_12__.initMoreBtn)();
  (0,_modules_init_product_handler_js__WEBPACK_IMPORTED_MODULE_13__.initProductHandler)();
  (0,_modules_show_more_init_show_more_js__WEBPACK_IMPORTED_MODULE_14__.initShowMore)();

  // все скрипты должны быть в обработчике 'DOMContentLoaded', но не все в 'load'
  // в load следует добавить скрипты, не участвующие в работе первого экрана
  window.addEventListener('load', function () {
    (0,_modules_sliders_init_object_slider_js__WEBPACK_IMPORTED_MODULE_8__.initObjectSlider)();
  });
});
