...
var Feedback = /*#__PURE__*/function () {
  ...
  return _createClass(Feedback, [{
    ...
    key: "_onSubmitForm",
    value: function _onSubmitForm(evt) {
      console.log('hello');
      evt.preventDefault();
      var feedback = evt.target.parentElement;
      var errors = evt.target.querySelector('[data-feedback-errors]');
      ...
      if (this._errors.size) {
        ...
        var recaptchaToken = evt.target.querySelector('[data-recaptcha-token]');
    ...
    value: function _validateForm(form) {
      ...
      fields.forEach(function (field) {
        ...
        switch (type) {
          case 'text':
            _this2._validateTextField(field);
            break;
          case 'phone':
            _this2._validatePhoneField(field);
            break;
          case 'email':
            _this2._validateEmailField(field);
            break;
        }
      });
    }
    ...
    value: function _setErrors(element) {
      ...
      this._errors.forEach(function (error, errorAgain, set) {
        switch (error) {
          case 'required':
            result += _this3._createError('Заполните все обязательные поля');
            break;
          case 'phone':
            result += _this3._createError('Введите пожалуйста корректный номер телефона');
            break;
          case 'email':
            result += _this3._createError('Введите пожалуйста корректный адрес электронной почты');
            break;
        }
      });
